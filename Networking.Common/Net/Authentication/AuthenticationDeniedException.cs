...
namespace Networking.Common.Net.Authentication {
    /// <summary>
    ...
    public class AuthenticationDeniedException : Exception {
        ...
        /// </param>
        protected AuthenticationDeniedException(SerializationInfo info, StreamingContext context) : base(info, context) { }
