...
using Networking.Common.Net.Authentication.Messages;
...
namespace Griffin.Net.Authentication.HashAuthenticator {
    ...
    public class HashClientAuthenticator : IClientAuthenticator {
        private IAuthenticationMessageFactory _authenticationMessageFactory = new AuthenticationMessageFactory(new PasswordHasherRfc2898());
        ...
        /// </summary>
        public bool RequiresRawData { get { return false; } }
        ...
        /// <returns></returns>
        public int Process(ITcpChannel channel, ISocketBuffer buffer, out bool completed) { throw new NotSupportedException(); }
