...
namespace Networking.Common.Net.Authentication.Messages {
    ...
    public interface IAuthenticationMessageFactory {
        ...
        /// <remarks>
        ///     <para>
        ///         You are responsible of generating the session salt. You can for instance do that by using
        ///         <see cref="PasswordHasherRfc2898.CreateSalt" />.
        ///     </para>
        /// </remarks>
        ...
        ///     Token created by the server using <see cref="IAuthenticate.ClientSalt" /> to prove
        ///     the server identity. <c>null</c> if authentication failed.
        /// </param>
        /// <returns>message that can be serialized</returns>
