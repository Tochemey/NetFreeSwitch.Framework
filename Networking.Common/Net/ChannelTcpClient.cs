...
namespace Networking.Common.Net {
    ...
    public class ChannelTcpClient : IDisposable {
        ...
        ///     </para>
        /// </remarks>
        public BufferPreProcessorHandler BufferPreProcessor { get { return _channel.BufferPreProcessor; } set { _channel.BufferPreProcessor = value; } }
        ...
        public Task<object> ReceiveAsync() { return ReceiveAsync(TimeSpan.FromMilliseconds(-1), CancellationToken.None); }
        ...
        /// </returns>
        public Task<object> ReceiveAsync(CancellationToken cancellation) { return ReceiveAsync(TimeSpan.FromMilliseconds(-1), CancellationToken.None); }
        ...
        /// <returns>Decoded message</returns>
        /// <exception cref="ChannelException">
        ///     Was signalled that something have been recieved, but found nothing in
        ///     the in queue
        /// </exception>
        public Task<object> ReceiveAsync(TimeSpan timeout) { return ReceiveAsync(timeout, CancellationToken.None); }
