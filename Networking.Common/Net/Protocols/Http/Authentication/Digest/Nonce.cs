...
namespace Networking.Common.Net.Protocols.Http.Authentication.Digest {
    ...
    public class Nonce {
        ...
        /// </summary>
        public IEnumerable<int> PassedCounts { get { return _counts; } }
        ...
        /// </summary>
        public bool Expired { get { return _expires > DateTime.Now; } }
        ...
        public bool Validate(int value) {
            if (PassedCounts.Contains(value)
                || value <= (PassedCounts.Any() ? PassedCounts.Min() : 0)) return false;
            if (_counts.Count <= 5
                || value > 5)
                return false;
