...
namespace Networking.Common.Net.Protocols.Http.Authentication {
    ...
    public class BasicAuthentication : IAuthenticator {
        ...
        public string AuthenticationScheme { get { return "basic"; } }
        ...
        public IAuthenticationUser Authenticate(IHttpRequest request) {
            ...
            if (pos == -1)
                throw new BadRequestException("Invalid basic authentication header, failed to find colon. Got: " + authHeader);
