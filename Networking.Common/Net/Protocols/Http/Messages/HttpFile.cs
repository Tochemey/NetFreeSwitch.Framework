...
namespace Networking.Common.Net.Protocols.Http.Messages {
    ...
    public class HttpFile : IHttpFile, IDisposable {
        ...
        public void Dispose() { File.Delete(TempFileName); }
        ...
        public void Move(string destination) { File.Move(TempFileName, destination); }

        /// <summary>
        ///     Delete file
        /// </summary>
        public void Delete() { File.Delete(TempFileName); }
