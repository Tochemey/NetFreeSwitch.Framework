...
namespace Networking.Common.Net.Protocols.Http.WebSocket {
    ...
    public class WebSocketListener : HttpListener {
        ...
        public WebSocketListener(ChannelTcpListenerConfiguration configuration) : base(configuration) { }

        /// <summary>
        ///     Create a new instance of  <see cref="WebSocketListener" />.
        /// </summary>
        public WebSocketListener() {
            var config = new ChannelTcpListenerConfiguration(() => new WebSocketDecoder(), () => new WebSocketEncoder());
        ...
        /// </summary>
        public MessageHandler WebSocketMessageReceived { get { return _webSocketMessageReceived; } set { _webSocketMessageReceived = value ?? delegate { }; } }
