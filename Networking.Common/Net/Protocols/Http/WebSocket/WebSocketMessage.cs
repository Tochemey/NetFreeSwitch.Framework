...
namespace Networking.Common.Net.Protocols.Http.WebSocket {
    ...
    public class WebSocketMessage : IWebSocketMessage {
        /// <summary>
        ///     Creates a new WebSocket message with empty payload. This is useful for control messages such as PING, PONG and
        ///     CLOSE
        /// </summary>
        /// <param name="opcode">opcode</param>
        public WebSocketMessage(WebSocketOpcode opcode) : this(opcode, Stream.Null) { }
