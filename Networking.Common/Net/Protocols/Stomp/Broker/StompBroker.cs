...
using Networking.Common.Net.Protocols.Stomp.Broker.MessageHandlers;
using Networking.Common.Net.Protocols.Stomp.Broker.Services;
using DisconnectHandler = Networking.Common.Net.Protocols.Stomp.Broker.MessageHandlers.DisconnectHandler;
...
namespace Networking.Common.Net.Protocols.Stomp.Broker {
    ...
    public class StompBroker {
        ...
        ///     assigned port.
        /// </remarks>
        public int LocalPort { get { return _tcpListener.LocalPort; } }

        //TODO: Use a dictionary instead.
        private StompClient GetClient(ITcpChannel channel) { return _clients.First(x => x.IsForChannel(channel)); }
        ...
        public void Start(IPAddress address, int port) { _tcpListener.Start(address, port); }

        private void OnClientConnected(object sender, ClientConnectedEventArgs e) { _clients.Add(new StompClient(e.Channel, new TransactionManager())); }
