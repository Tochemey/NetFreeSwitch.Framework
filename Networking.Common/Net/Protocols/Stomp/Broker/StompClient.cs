...
namespace Networking.Common.Net.Protocols.Stomp.Broker {
    ...
    public class StompClient : IStompClient {
        ...
        /// </summary>
        private ITcpChannel Channel { get; }
        ...
        /// </summary>
        public EndPoint RemoteEndpoint { get { return Channel.RemoteEndpoint; } }

        /// <summary>
        ///     Returns if this client has one or more active transactions
        /// </summary>
        public bool HasActiveTransactions { get { return _transactionManager.HasActiveTransactions; } }
