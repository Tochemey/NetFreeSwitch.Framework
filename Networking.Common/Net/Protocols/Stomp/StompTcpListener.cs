...
namespace Networking.Common.Net.Protocols.Stomp {
    ...
    public class StompTcpListener : ChannelTcpListener {
        ...
        protected override void OnMessage(ITcpChannel source, object msg) { base.OnMessage(source, msg); }
        ...
        /// <returns></returns>
        protected override ClientConnectedEventArgs OnClientConnected(ITcpChannel channel) { return base.OnClientConnected(channel); }
    }
}