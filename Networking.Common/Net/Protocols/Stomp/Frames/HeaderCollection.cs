...
namespace Networking.Common.Net.Protocols.Stomp.Frames {
    /// <summary>
    ...
    public class HeaderCollection : IHeaderCollection {
        ...
        /// </returns>
        public bool Contains(string name) { return _items.ContainsKey(name); }
        ...
        /// </returns>
        public IEnumerator<KeyValuePair<string, string>> GetEnumerator() { return _items.GetEnumerator(); }
