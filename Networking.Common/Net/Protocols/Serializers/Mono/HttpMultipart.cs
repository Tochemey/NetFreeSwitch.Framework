...
namespace Networking.Common.Net.Protocols.Serializers.Mono {
    /// <summary>
    ...
    internal class HttpMultipart {
        ...
        private long MoveToNextBoundary() {
            ...
            while (true) {
                ...
                if (state == 0
                    ...
                    if (buffer[bl - 2] == '-'
                        && buffer[bl - 1] == '-') _atEof = true;
                    else if (buffer[bl - 2] != CR
                             || buffer[bl - 1] != LF) {
                        state = 0;
                        data.Position = retval + 2;
                        if (got_cr) {
        ...
        public Element ReadNextElement() {
            ...
            while ((header = ReadHeaders()) != null) {
                ...
                else if (StrUtils.StartsWith(header, "Content-Type:", true)) elem.ContentType = header.Substring("Content-Type:".Length).Trim();
            }
        ...
        public class Element {
            ...
            public override string ToString() { return "ContentType " + ContentType + ", Name " + Name + ", Filename " + Filename + ", Start " + Start + ", Length " + Length; }
        }
