namespace Networking.Common.Net.Protocols.FreeSwitch.Command {
    ...
    /// </summary>
    public class GetVarCommand : BaseCommand {
        /// <summary>
        ...
        public override string Command { get { return "uuid_getvar"; } }

        public override string Argument { get { return string.Format("{0} {1}", _uuid, _name); } }
    }
}