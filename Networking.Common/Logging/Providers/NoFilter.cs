...
namespace Networking.Common.Logging.Providers {
    ...
    public class NoFilter : ILoggerFilter {
        ...
        /// </summary>
        /// <param name="typeThatWantToLog">
        ///     Type that wants to get a logger to be able to log entries that have been written by the
        ///     dev.
        /// </param>
        /// <returns>Always <c>true</c>. <c>true</c>.</returns>
        public bool IsSatisfiedBy(Type typeThatWantToLog) { return true; }
    }
}