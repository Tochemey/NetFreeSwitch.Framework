...
namespace Networking.Common.Logging.Providers {
    ...
    public class NamespaceFilter : ILoggerFilter {
        ...
        /// </remarks>
        public NamespaceFilter(string allowedIncludingChildNamespaces = null, string revokedIncludingChildNamespaces = null) {
        ...
        private class NamespaceFltr {
            ...
            private string AllowedNamespace { get; }
            private bool AllowChildNamespaces { get; }
