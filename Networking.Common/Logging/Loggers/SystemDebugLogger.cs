...
namespace Networking.Common.Logging.Loggers {
    ...
    public class SystemDebugLogger : BaseLogger {
        ...
        ///     lines come from.
        /// </param>
        public SystemDebugLogger(Type typeThatLogs) : base(typeThatLogs) { }
        ...
        /// <remarks>
        ///     <para>
        ///         Will traverse all frames in the stack the first time this method is called. Will only get the correct frame
        ///         all other times.
        ///     </para>
        /// </remarks>
        ...
        public override void Write(LogEntry entry) {
            ...
            if (UseStackFrame) {
                ...
                caller = frame.GetMethod().ReflectedType.Name + "." + frame.GetMethod().Name + "():" + frame.GetFileLineNumber();
            }
            else caller = LoggedType.Namespace ?? "";

            var color = Console.ForegroundColor;
            System.Diagnostics.Debug.WriteLine(DateTime.Now.ToString("yyyy-MM-dd HH:mm:ss.fff") + " " + caller.PadRight(50) + entry.LogLevel.ToString().PadRight(10) + entry.Message);
