...
namespace Networking.Common.Logging.Loggers {
    ...
    public class ConsoleLogger : BaseLogger {
        ...
        public ConsoleLogger(Type typeThatLogs) : base(typeThatLogs) { }
        ...
        public override void Write(LogEntry entry) {
            ...
            Console.WriteLine(DateTime.Now.ToString("yyyy-MM-dd HH:mm:ss.fff") + " " + caller.PadRight(50) + entry.LogLevel.ToString().PadRight(10) + entry.Message);
