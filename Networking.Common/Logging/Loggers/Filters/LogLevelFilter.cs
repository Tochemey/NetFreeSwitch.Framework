namespace Networking.Common.Logging.Loggers.Filters {
    /// <summary>
    ...
    public class LogLevelFilter : ILogEntryFilter {
        ...
        /// </returns>
        public bool IsSatisfiedBy(LogEntry logEntry) { return logEntry.LogLevel >= MinLevel && logEntry.LogLevel <= MaxLevel; }
    }
}