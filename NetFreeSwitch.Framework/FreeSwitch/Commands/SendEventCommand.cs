...
namespace NetFreeSwitch.Framework.FreeSwitch.Commands {
    ...
    /// SendEvent command
    /// </summary>
    public class SendEventCommand : BaseCommand {
        ...
        public override string Command { get { return "sendevent"; } }
        public override string Argument { get { return _event.ToEventCommandString(); } }
    }
}