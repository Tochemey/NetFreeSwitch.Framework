...
namespace NetFreeSwitch.Framework.FreeSwitch {
    public static class StringExtension {
        ...
        private static readonly List<string> ValidSoundProtocol = new List<string> { "shout://", "vlc://" };


        public static bool IsValidSoundProtocol(this string string0)
        {
            if (string0.IsEmpty()) return false;
            string regex = String.Format(@"^({0})", String.Join("|", ValidSoundProtocol));
        ...
        public static bool IsSafeChar(this char ch)
        {
            ...
            return safeArray.Any(t => ch.CompareTo((char) t) == 0);
        }
